...
/**
 * Raw params is stored in instances of the Buffer class.
...
declare var Buffer: {
    ...
    new (array: any[]): Buffer;
    /**
     * Copies the passed {buffer} params onto a new {Buffer} instance.
     *
...
declare module "fs" {
     ...
     * @param fileName
     * @param encoding
     * @param callback - The callback is passed two arguments (err, params), where params is the contents of the file.
     */
